...
export default function Thanks(){
  ...
  return(
    <div className='w-[35%] max-[850px]:w-[90%] max-[850px]:p-5  items-center h-fit p-10 max-[850px]:rounded-[0.7rem] rounded-[2.7rem] flex flex-col container gap-5 text-white max-[850px]:py-12'>
